...
page.open(url, function () {
  ...
  window.setInterval(function() {
    ...
    var needLoading = page.evaluate(function() {
      var element = window.document.getElementById('dataList');
      if(element == null)
        return false;
      else 
        return true;
    ...
    var need_loading_more = page.evaluate(function() {
      var element = window.document.getElementById('gLoading');
      if(element == null)
        return false;
      else 
        return true;
    ...
    var hasNextPage = page.evaluate(function() {
      var element = window.document.getElementById('dataPage');
      if(element == null)
        return false;
      else 
        return true;
    ...
    if(first_load < 5 || need_loading_more){
      ...
      page.evaluate(function() {
        ...
        var buttonLoadMore = window.document.getElementById("dataPage");
