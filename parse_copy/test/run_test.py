...
from python_library.xpather import Xpather
reload(sys)
...
def download_with_phantomjs(url):
  js_bin_path = '../../le_crawler/js_dep/letv_crawler_ptj'
  js_script_path = '../../le_crawler/js_dep/get_html.js'
...
def main(argv):
  ...
  xpather = Xpather()
  xpather.load_templates('video_templates/')
  result = {}
  if len(argv) == 1:
