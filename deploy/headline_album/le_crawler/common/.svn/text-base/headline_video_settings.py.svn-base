...
ACCEPT_URL_REG = {
    ...
    "smgbb.cn" : [r'.*(/vplay/v-\d+/)'],#.* stands for www.fun.tv or news.smgbb.cn
    "v.ifeng.com" : [r'.*(v\.ifeng\.com)\/.*',
      r'.*(v\.ifeng\.com)\/news\/.*',
    ...
    "tv.people.com.cn" : [r'(tv\.people\.com\.cn).*(/(n|GB)/).*(html|shtml|htm)'],
    "v.qq.com" : [r'(v\.qq\.com)\/cover\/.*(html|shtml|htm).*'],
    "video.sina.com.cn" : [r'(.*\.sina\.com\.cn).*(p|vlist)\/(news|ent)\/.*',
      r'(.*\.sina\.com\.cn).*(\/mil\/).*',
    ...
    "tv.sohu.com" : [r'.*(tv\.sohu\.com)\/\d+\/n\d+\.(shtml|html|htm)'],
...
TABLE_NAME = {
     ...
     "v.ifeng.com":"IfengMoviesWebDB",
     "iqiyi.com":"IqiyiMoviesWebDB",
     "ku6.com": "Ku6MoviesWebDB",
     "tv.people.com.cn": "PeopleMoviesWebDB",
     "v.qq.com" : "QQMoviesWebDB",
     "video.sina.com.cn":"SinaMoviesWebDB",
     "tv.sohu.com":"SohuMoviesWebDB",
