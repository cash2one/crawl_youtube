...
if __name__ == "__main__":
  url_p = "http://ent.ifeng.com/listpage/236/(*)/list.shtml ieieieow"
  f = 1
  t = 330
  for l in extend_url(url_p, '0', '10', 3)[1]:
    print l
  url_p = "http://ent.ifeng.com/listpage/236/1/list.shtml"
  for l in extend_url(url_p, '0', '10', 3)[1]:
    print l
  url_p = "http://ent.ifeng.com/listpage/236/(*)/list.shtml"
  for l in extend_url(url_p, 'a', 'z')[1]:
    print l
#  for l in load_lines_with_extend('/tmp/test.txt', True):
#    print l
