...
re_pattn_usfulltail =\
                 re.compile(ur"(.*?)([年|月|日|(小时)|分|秒|(年前)|(月前)|(周前)|(天前)|(小时前)|(分前)|(分钟前)|(秒前)])$")
...
re_pattn_timeago =\
                  re.compile(ur"[^\d]*?(\d+)[\s　 ]*(年前|月前|周前|天前|小时前|分前|分钟前|秒前|years|months|weeks|days|hours|minutes|seconds)+.*")
...
class TimestrParser(object):
  ...
  def __init__(self):
    ...
    self.timedeltaunitlist = {u"年前":0,u"月前":0,u"周前":604800,u"天前":86400,u"小时前":3600,u"分前":60,u"分钟前":60,u"秒前":1,
...
if __name__ == "__main__":
  ...
  test_timestr = {
                  u"2014-5-19 10:10 重庆时报":1400465400,
