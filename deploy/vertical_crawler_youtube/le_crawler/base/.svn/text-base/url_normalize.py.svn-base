...
def get_abs_url(base_url, test_url, canonicalize = False):
  ...
  npth = os.path.abspath(os.path.join(npth, test_url))
...
class UrlNormalize():
  ...
  @staticmethod
  def get_instance(module_path = 'le_crawler.base.url_normalize_settings',
      *kargs, **kwargs):
...
if __name__ == '__main__':
  print 'test...'
  test_url = get_abs_url('http://top.baidu.com/boards?fr=topdetail_b16_c9',
      './buzz?b=396')
  assert test_url == 'http://top.baidu.com/buzz?b=396', test_url
  test_url = get_abs_url('http://top.baidu.com/boards/?fr=topdetail_b16_c9',
      './buzz?b=396')
  assert test_url == 'http://top.baidu.com/boards/buzz?b=396', test_url
  test_url = get_abs_url('http://top.baidu.com/boards/?fr=topdetail_b16_c9',
      '../buzz?b=396')
  assert test_url == 'http://top.baidu.com/buzz?b=396', test_url
  test_url = get_abs_url('http://top.baidu.com/boards/?fr=topdetail_b16_c9',
      '../../buzz?b=396')
  assert test_url == 'http://top.baidu.com/buzz?b=396', test_url
  test_url = get_abs_url('http://top.baidu.com/boards/test/?fr=topdetail_b16_c9',
      '/../buzz?b=396')
  assert test_url == 'http://top.baidu.com/buzz?b=396', test_url
  test_url = get_abs_url('http://top.baidu.com/boards/test/?fr=topdetail_b16_c9',
      './../buzz?b=396')
  ...
  test_url = get_abs_url('http://google.com/test', '../../home_test')
  assert test_url == 'http://google.com/home_test', test_url
