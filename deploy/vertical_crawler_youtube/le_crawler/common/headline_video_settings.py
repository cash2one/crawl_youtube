...
PROPERTY_PATH = {
    ...
    "qq.com" : {#modified
      ...
      "title":[['./a/img/@alt', './u1/li/p/a/text()','./div/a/@title','./h6/a/@title'],],
      "cover":[['./a/img/@src','./div/a/img/@src'],],
    ...
    "youku.com" : {#added
      ...
      "download_count":[[ './div/div[@class="v-meta-entry"]/span[@class="v-num"]/text()', './li[@class="v_stat"]/span[@class="num"]/text()' ], 0,],
